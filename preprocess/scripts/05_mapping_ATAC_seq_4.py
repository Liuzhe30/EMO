...
new_path = '../../3_ATAC_0.001/'
file_path = '../../2_ppc_0.001_seq_mapping/'

gtex_bulk_list = ['Colon_Sigmoid', 'Colon_Transverse', 'Pancreas']
...
for bulk in gtex_bulk_list:
    for chr_no in range(1, 23):
        ...
        bw_4 = pyBigWig.open(atac_path + bulk + "_4.bw")
        ...
        for i in range(len(data)):
            ...
            if(tss_distance > 0):
                if(tss_position > max_atac_len):
                    ...
                    atac_between_4 = bw_4.values("chr" + str(chr_no), tss_position - 1, max_atac_len)
                    atac_between_4 = [0 if item == 'nan' else item for item in atac_between_4]
                    atac_between = [atac_between_1, atac_between_2, atac_between_3, atac_between_4]
                    ...
                    atac_between_3 = [0 if item == 'nan' else item for item in atac_between_3]
                    atac_between_4 = bw_4.values("chr" + str(chr_no), tss_position - 1, position)
                    atac_between_4 = [0 if item == 'nan' else item for item in atac_between_4]
                    atac_between = [atac_between_1, atac_between_2, atac_between_3, atac_between_4]
                    atac_between = list(np.mean(atac_between, axis=0))
            else:
                if(position > max_atac_len):
                    ...
                    atac_between_3 = [0 if item == 'nan' else item for item in atac_between_3]
                    atac_between_4 = bw_4.values("chr" + str(chr_no), position - 1, max_atac_len)
                    atac_between_4 = [0 if item == 'nan' else item for item in atac_between_4]
                    atac_between = [atac_between_1, atac_between_2, atac_between_3, atac_between_4]
                    atac_between = list(np.mean(atac_between, axis=0))
                    ...
                    atac_between_3 = [0 if item == 'nan' else item for item in atac_between_3]
                    atac_between_4 = bw_4.values("chr" + str(chr_no), position - 1, tss_position)
                    atac_between_4 = [0 if item == 'nan' else item for item in atac_between_4]
                    atac_between = [atac_between_1, atac_between_2, atac_between_3, atac_between_4]
                    atac_between = list(np.mean(atac_between, axis=0))
            ...
            if(position - 25 > max_atac_len):
                ...
                atac_variant_51_4 = bw_4.values("chr" + str(chr_no), position - 26, max_atac_len)
                atac_variant_51_4 = [0 if item == 'nan' else item for item in atac_variant_51_4]
                atac_variant_51 = [atac_variant_51_1, atac_variant_51_2, atac_variant_51_3, atac_variant_51_4]
                ...
                atac_variant_51_3 = [0 if item == 'nan' else item for item in atac_variant_51_3]
                atac_variant_51_4 = bw_4.values("chr" + str(chr_no), position - 26, position + 25)
                atac_variant_51_4 = [0 if item == 'nan' else item for item in atac_variant_51_4]
                atac_variant_51 = [atac_variant_51_1, atac_variant_51_2, atac_variant_51_3, atac_variant_51_4]
                atac_variant_51 = list(np.mean(atac_variant_51, axis=0))
            ...
            if(tss_position - 25 > max_atac_len):
                ...
                atac_tss_51_4 = bw_4.values("chr" + str(chr_no), tss_position - 26, max_atac_len)
                atac_tss_51_4 = [0 if item == 'nan' else item for item in atac_tss_51_4]
                atac_tss_51 = [atac_tss_51_1, atac_tss_51_2, atac_tss_51_3, atac_tss_51_4]
                ...
                atac_tss_51_3 = [0 if item == 'nan' else item for item in atac_tss_51_3]
                atac_tss_51_4 = bw_4.values("chr" + str(chr_no), tss_position - 26, tss_position + 25)  
                atac_tss_51_4 = [0 if item == 'nan' else item for item in atac_tss_51_4]
                atac_tss_51 = [atac_tss_51_1, atac_tss_51_2, atac_tss_51_3, atac_tss_51_4]
                atac_tss_51 = list(np.mean(atac_tss_51, axis=0))
            
            atac_between_array = np.array(atac_between, dtype=np.float16)
            atac_variant_51_array = np.array(atac_variant_51, dtype=np.float16)
            atac_tss_51_array = np.array(atac_tss_51, dtype=np.float16)
            
            data.at[i, 'atac_between'] = atac_between_array
            data.at[i, 'atac_variant_51'] = atac_variant_51_array
            data.at[i, 'atac_tss_51'] = atac_tss_51_array
        print(data)
