...
snp_df = pd.read_csv('data/metabrain_case.csv')
print(snp_df.head())
'''
             Disease   variant_id     gene tissue  slope Ref Alt    CHR  \
0  MultipleSclerosis  rs1465697-T  CCDC155   CD4T      0   C   T  chr19   

    SNP_POS   TSS_POS  tss_distance  
0  49333989  49388248        -54259  
'''

# mapping sequence
fasta_path = '../../datasets/chr_fasta_hg38/'
output_path = 'data/rs1465697_large_seq.pkl'
data = snp_df
...
output_path = 'data/'
file_path = 'data/rs1465697_large_seq.pkl'

for cell in cell_list:

    data = pd.read_pickle(file_path)
    atac_path = 'scATAC/' + cell + '.bigWig'
    ...
    #print(data)
    data.to_pickle(output_path + 'rs1465697_large_' + cell + '.dataset')