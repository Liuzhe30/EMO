...
file_path = 'D:/eQTL_SNP/dataset/1_ppc_0.9_single_mutation/'
    ...
    for chr_no in range(1, 23):
        ...
        for i in range(len(data)):        
            ...
            with open(fasta_path + chr_str + '_new.fasta') as fa:
                ...
                #print(data)
        new_file_down = 'D:/eQTL_SNP/dataset/2_ppc_0.9_seq_mapping/' + bulk + '_' + str(chr_no) + '.pkl'
        #print(data)
